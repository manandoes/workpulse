...
export const metadata: Metadata = {
  ...
  description:
    "How AgencyOS handles your company's data, including tenant isolation.",
};
...
export default function PrivacyPage() {
  return (
    <PagePlaceholder
      ...
      description="This page will explain what data AgencyOS stores, how each company's data is kept isolated from every other company, and how long it is retained."
