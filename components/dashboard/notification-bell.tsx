  ...
  return (
    <div ref={containerRef} className={cn("relative", className)}>
      <button
        ...
        className="text-brand-brown-light hover:bg-brand-brown-soft/40 hover:text-background relative flex size-9 items-center justify-center rounded-lg transition-colors"
      >
