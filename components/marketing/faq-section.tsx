...
const FAQS = [
  {
    ...
    answer:
      "No. AgencyOS covers day-to-day operations — people, projects, tasks, workload, performance, and internal requests. It deliberately leaves out payroll processing, tax compliance, and statutory HR filings, so it complements an HRMS rather than replacing one.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. AgencyOS is multi-tenant, and every record belongs to exactly one company. Every query is scoped to the company of the signed-in user, so one company's data can never appear in another's view.",
  },
  {
